...
let shipImg, shipVelocityX = tileSize;
...
function moveShip(e) {
    ...
    if (e.code === "ArrowRight" && ship.x + shipVelocityX + ship.width <= board.width) ship.x += shipVelocityX;
}
...
function endGame() {
    ...
    if (score > highScore) {
        ...
        document.getElementById("high-score").textContent = highScore; // Actualiza el marcador de mejor puntuación
    }
